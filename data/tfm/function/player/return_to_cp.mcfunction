...
execute if score @s player_checkpoint matches 3 run tp @s 153.5 88.0 8.0 90 0
execute if score @s player_checkpoint matches 4 run tp @s 113.0 102.0 -16.5 180 0
execute if score @s player_checkpoint matches 5 run tp @s 91.0 92.0 10.5 0 0
