...
execute store result score @s player_double_jump_init_speed run data get entity @s Motion[1] 445
execute store result score #digit_1000 player_double_jump_init_speed run scoreboard players add @s player_double_jump_init_speed 135
...
scoreboard players set @s player_double_jump_gravity_reset_cd -2