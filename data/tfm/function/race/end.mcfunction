execute if score @s player_checkpoint matches 1 run return run function tfm:race/quit

execute unless score @s player_checkpoint matches 8 run return -1
...
execute if score @s player_timer_mil matches ..9 if score @s player_timer_sec matches ..9 run tellraw @a [{text:"[",color:"gray"},{text:"TFP",color:"blue"},{text:"] ",color:"gray"},{selector:"@s"},{text:" finished at ",color:"gold"},{score:{name:"@s",objective:"player_timer_min"},color:"yellow"},{text:":",color:"white"},{text:"0",color:"yellow"},{score:{name:"@s",objective:"player_timer_sec"},color:"yellow"},{text:":",color:"white"},{text:"0",color:"yellow"},{score:{name:"@s",objective:"player_timer_mil"},color:"yellow"},{text:" !",color:"white"}]
execute if score @s player_timer_mil matches ..9 if score @s player_timer_sec matches 10.. run tellraw @a [{text:"[",color:"gray"},{text:"TFP",color:"blue"},{text:"] ",color:"gray"},{selector:"@s"},{text:" finished at ",color:"gold"},{score:{name:"@s",objective:"player_timer_min"},color:"yellow"},{text:":",color:"white"},{score:{name:"@s",objective:"player_timer_sec"},color:"yellow"},{text:":",color:"white"},{text:"0",color:"yellow"},{score:{name:"@s",objective:"player_timer_mil"},color:"yellow"},{text:" !",color:"white"}]

execute if score @s player_timer_mil matches 10.. if score @s player_timer_sec matches ..9 run tellraw @a [{text:"[",color:"gray"},{text:"TFP",color:"blue"},{text:"] ",color:"gray"},{selector:"@s"},{text:" finished at ",color:"gold"},{score:{name:"@s",objective:"player_timer_min"},color:"yellow"},{text:":",color:"white"},{text:"0",color:"yellow"},{score:{name:"@s",objective:"player_timer_sec"},color:"yellow"},{text:":",color:"white"},{score:{name:"@s",objective:"player_timer_mil"},color:"yellow"},{text:" !",color:"white"}]
execute if score @s player_timer_mil matches 10.. if score @s player_timer_sec matches 10.. run tellraw @a [{text:"[",color:"gray"},{text:"TFP",color:"blue"},{text:"] ",color:"gray"},{selector:"@s"},{text:" finished at ",color:"gold"},{score:{name:"@s",objective:"player_timer_min"},color:"yellow"},{text:":",color:"white"},{score:{name:"@s",objective:"player_timer_sec"},color:"yellow"},{text:":",color:"white"},{score:{name:"@s",objective:"player_timer_mil"},color:"yellow"},{text:" !",color:"white"}]

scoreboard players set @s player_checkpoint 9

function tfm:leaderboard/add_to_leaderboard